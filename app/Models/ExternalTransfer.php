...
class ExternalTransfer extends Model
{
    ...
    protected $fillable = ['stock_id', 'ex_transfer_id', 'driver_id', 'delivery_id', 'warehouse_id', 'registration', 'transporter_id', 'transferred_palettes', 'transferred_weight', 'created_by', 'status', 'delivery_number'];
