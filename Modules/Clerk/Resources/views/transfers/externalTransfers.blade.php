                    ...
                    <table class="table mb-0 table-bordered table-striped" id="datatable">
                        ...
                        @foreach($transfers as $transfer)
                            <tr>
                                ...
                                <td>
                                    {!! $transfer->status === 0 ? '<span class="badge bg-warning"> Created </span>' : ($transfer->status == 1 ?  '<span class="badge bg-danger"> Created <span>' : ($transfer->status == 2 ? '<span class="badge bg-info"> Approved <span>' : '<span class="badge bg-success"> Released <span>')) !!}
                                </td>
                                <td nowrap="">
