                                    ...
                                    <div class="row">
                                        <form method="POST" action="{{ route('accounts.addClientAccount') }}">
                                            ...
                                            <div class="mb-4" >
                                                ...
                                                <select name="type" id="account_currency" class="form-select choices" required>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="{{ route('accounts.updateClientAccount', $account->client_account_id) }}">
                                                    @csrf
                                                    <div class="mb-4">
                                                        <label class="my-1 fs-xs fw-bold" style="font-size: 100% !important;">CLIENT NAME</label> <br>
                                                        <input id="editableSelect" type="text" list="clients" value="{{ $account->client_account_name }}" name="account_name" class="form-control form-select-lg editableSelect" placeholder="-- client name --" required style="height: 100% !important;">
                                                        <datalist id="clients">
                                                            @foreach($clients as $client)
                                                                <option value="{{ $client }}">{{ $client }}</option>
                                                            @endforeach
                                                    ...
                                                    <div class="mb-4" >
                                                        ...
                                                        <select name="account_category" class="form-select form-select-lg readonly" required disabled>
                                                            <option disabled selected>-- select account --</option>
                                                            @foreach($categories as $category)
                                                    ...
                                                    <div class="mb-4" >
                                                        ...
                                                        <select name="account_currency" class="form-select js-choice" required>
                                                            <option selected disabled value=""> -- select currency --  {{ $account->currency_id }} </option>
                                                    ...
                                                    <div class="mb-4" >
                                                        ...
                                                        <select name="account_status" id="" class="form-select js-choice" required>
                                                    ...
                                                    <div class="mb-4" >
                                                        <select name="type" id="" class="form-select js-choice">
