        ...
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-6 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-9 mb-0 text-nowrap py-0 py-xl-0"> Income Ledgers Invoiced </h5>
                </div>
                    ...
                    <table class="table mb-0 table-bordered table-striped" id="datatable">
                        ...
                        @foreach($invoices as $invoice)
                            <tr>
                                ...
                                <td>
                                    <a class="link link-dark" data-bs-toggle="tooltip" data-bs-placement="left" title="VIew Ledger Statement" href="{{ route('accounts.viewLedgerStatement', base64_encode($invoice->client_account_id.':'.$invoice->financial_year_id)) }}"><span class="fas fa-folder-open"></span> </a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
