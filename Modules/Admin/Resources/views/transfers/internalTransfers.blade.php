                    ...
                    <table class="table mb-0 table-bordered table-striped" id="datatable">
                        ...
                        @foreach($transfers as $transfer)
                            <tr>
                                ...
                                <td>
                                    {!! $transfer->status === null ? '<span class="badge bg-warning"> Created </span>' : ($transfer->status == 0 ? '<span class="badge bg-dark">  Initiated <span>' : ($transfer->status == 1 ? '<span class="badge bg-info"> Approved <span>' : ($transfer->status == 2 ? '<span class="badge bg-danger"> Released <span>' : '<span class="badge bg-success"> Received <span>'))) !!}
                                </td>
                                <td nowrap="">
