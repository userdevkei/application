                        ...
                        <div class="modal-content border-0">
                            ...
                            <div class="modal-body p-0">
                                ...
                                <div class="p-4">
                                    ...
                                    <form method="POST" action="{{ route('admin.storeReport') }}">
                                        @csrf
                        ...
                        @foreach($requests as $request)
                            <tr>
                                ...
                                <td nowrap="">
                                        ...
                                        <a class="text-dark" aria-expanded="false" data-bs-toggle="tooltip" title="Download Report Request" href="{{ route('admin.downloadReportRequest', $request->request_id) }}"> <span class="fa fa-cloud-download-alt"> </span> </a>
