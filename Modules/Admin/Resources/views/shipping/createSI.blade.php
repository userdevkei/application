        ...
        <div class="card-body overflow-hidden p-lg-3">
            <div class="row align-items-center">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-c3976e0e-38db-410e-861a-36d04a3a7494" id="dom-c3976e0e-38db-410e-861a-36d04a3a7494">
                    <form method="POST" action="{{ route('admin.addShippingInstruction') }}">
                        @csrf
                        <div class="row g-2 needs-validation" novalidate="">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control form-control-lg"  type="text" name="shipmentNumber" placeholder="provide total net weight" />
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="floatingInputValid">SHIPPING MARK</label>
                                <input class="form-control form-control-lg" id="totalWeight" type="text" name="mark" placeholder="provide total net weight" />
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="floatingInputValid">CONSIGNEE</label>
                                <input class="form-control form-control-lg" id="totalWeight" type="text" name="consignee" placeholder="provide total net weight" />
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="floatingInputValid">VESSEL NAME</label>
                                <input class="form-control form-control-lg" type="text" name="vessel" placeholder="provide total net weight" />
                            </div>
                        </div>
